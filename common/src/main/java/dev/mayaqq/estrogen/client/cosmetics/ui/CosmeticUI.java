...
public class CosmeticUI {
    ...
    public static final MutableComponent NO_COSMETICS = Component.translatable("gui.estrogen.cosmetics.no_cosmetics");
    public static final MutableComponent PATREON_LINK = Component.translatable("gui.estrogen.cosmetics.patreon_link");
